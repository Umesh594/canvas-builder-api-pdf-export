...
app.post('/api/canvas/add/text', (req, res) => {
  ...
  // Convert to number or fallback if invalid (NaN or missing)
...
ctx.fillRect(0, 0, canvas.width, canvas.height);
  ...
  ? canvas.toBuffer('image/jpeg', { quality: 0.5 }) // compress JPEG
  : canvas.toBuffer('image/png'); // full quality PNG
